...
public class RelocateJarPackageTool extends JarPackageTool {
  ...
  public static void main(String[] args) throws Exception {
    CollectionBuilder<String, List<String>> cmd =
  ...
  protected static void runMvn(
      CollectionBuilder<String, List<String>> cmd,
      VMRunner vmRunner,
      String instrumentatorAgentPath)
      throws Exception, SavException {
    /* modify pom */
    reWritePom();
    /* copy files */
    ...
    sav.common.core.utils.FileUtils.copyFile(
        MAVEN_FOLDER + "/pom-bk.xml", MAVEN_FOLDER + "/pom.xml", true);
    new File(MAVEN_FOLDER + "/pom-bk.xml").delete();
  }

  private static void reWritePom() throws Exception {
    sav.common.core.utils.FileUtils.copyFile(
        MAVEN_FOLDER + "/pom.xml", MAVEN_FOLDER + "/pom-bk.xml", true);
