...
public class JarPackageTool {
  ...
  public static String getBaseDir() {
    String path =
        new File(JarPackageTool.class.getProtectionDomain().getCodeSource().getLocation().getPath())
            .getAbsolutePath();
    path = path.replace("\\", "/");
  ...
  public void exportToMicrobatLib() throws SavException {
    ...
    //		/* export & copy to microbat/lib */
    String microbatLibJar =
        BASE_DIR.replace("microbat_instrumentator/", "microbat/lib/instrumentator.jar");
    cmd.append(TestConfiguration.getJavaHome() + "/bin/jar")
        .append("cfm")
