...
public class ConditionVar extends LocalVar {
  ...
  /**
   * Prefix of id of condition result variable. <br>
   * <br>
  ...
  /**
   * Prefix of variable name of condition result. <br>
   * <br>
  ...
  public ConditionVar(
      final String name, final String type, final String locationClass, final int lineNumber) {
