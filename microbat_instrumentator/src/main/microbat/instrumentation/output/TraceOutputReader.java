...
public class TraceOutputReader extends OutputReader {
  ...
  public TraceOutputReader(
      InputStream in, String traceExecFolder, HashMap<Integer, SerializableLineInfo> opcodeTable) {
    super(in);
  ...
  private BreakPoint readLocation(String declaringCompilationUnitName) throws IOException {
    ...
    BreakPoint location =
        new BreakPoint(classCanonicalName, declaringCompilationUnitName, methodSig, lineNo);
