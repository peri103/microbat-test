...
public class TraceMeasurement {
  ...
  public void _hitLine(int line, String className, String methodSignature) {
    ...
    try {
      ...
      if (lastStep != null
          && lastStep.getClassCanonicalName().equals(className)
  ...
  public static synchronized TraceMeasurement _getTracer(
      String className, String methodSig, int methodStartLine) {
