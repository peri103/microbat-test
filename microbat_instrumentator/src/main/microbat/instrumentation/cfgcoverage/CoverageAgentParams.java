...
public class CoverageAgentParams extends CommonParams {
  ...
  public CoverageAgentParams(CommandLine cmd) {
    ...
    coverageType =
        CoverageCollectionType.valueOf(
            cmd.getString(OPT_COVERAGE_COLLECTION_TYPE), CoverageCollectionType.BRANCH_COVERAGE);
  }
  ...
  public static enum CoverageCollectionType {
    ...
    public static CoverageCollectionType valueOf(
        String strValue, CoverageCollectionType defaultValue) {
