 ...
 *     <p>This class is supposed to keep at very basic, NOT use or trigger ANY other liberay
...
public class LockedThreads {
   ...
   *
   * <p>the array length is initialized as 10, it can increase when the number of the threads grows.
   * See {@link LockedThreads#increaseSize()}
   *
   * <p>If a thread is in the state of TRACKING, all the relevant steps will be recorded (by
   * invoking {@code ExecutionTracer}). Otherwise, no step will be recorded (by invoking {@code
   * EmptyTracer})
   */
