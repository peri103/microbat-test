...
public class HeuristicIgnoringFieldRule {
  ...
  private static boolean isValidField(
      String fieldName, String className, Map<String, List<String>> ignoringMap) {
  ...
  /**
   * For some JDK class, we do not need its detailed fields. However, we may still be interested in
   * the elements in Collection class.
   *
   * @param type
   * @return
   */
  ...
  public static boolean isHashMapTableType(String type) {
    return "java.util.HashMap$Node".equals(type) || "java.util.HashMap$Entry".equals(type);
  }

  public static String getInfo() {
    StringBuilder sb = new StringBuilder();
    sb.append("isCollectionMap: ")
        .append(isCollectionMap.size())
        .append("isHashMapMap: ")
        .append(isHashMapMap.size())
        .append("isSerializableMap: ")
        .append(isSerializableMap.size())
        .append("parsingTypeMap: ")
        .append(parsingTypeMap.size());
    return sb.toString();
  }
