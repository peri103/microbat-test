...
public class AgentParams extends CommonParams {
  ...
  public AppJavaClassPath initAppClassPath() {
    return initAppClassPath(
        getLaunchClass(), getJavaHome(), getClassPaths(), getWorkingDirectory());
  }

  public static AppJavaClassPath initAppClassPath(
      String launchClass, String javaHome, List<String> classPaths, String workingDir) {
