...
public enum TracerMethods {
  AFTER_INVOKE(
      true,
      "microbat/instrumentation/runtime/IExecutionTracer",
      "_afterInvoke",
  ...
  GET_TRACER(
      ...
      "_getTracer",
      "(ZLjava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Lmicrobat/instrumentation/runtime/IExecutionTracer;",
      9),
  HIT_EXEPTION_TARGET(
      true,
      "microbat/instrumentation/runtime/IExecutionTracer",
  ...
  IINC_LOCAL_VAR(
      ...
      11),
  READ_ARRAY_ELEMENT_VAR(
      true,
      "microbat/instrumentation/runtime/IExecutionTracer",
      "_readArrayElementVar",
