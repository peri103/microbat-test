...
public class BasicTypeSupporter {
  ...
  public void appendObjectConvertInstruction(
      Type returnType, InstructionList newInsns, ConstantPoolGen constPool) {
    if (!Type.VOID.equals(returnType) && returnType instanceof BasicType) {
      newInsns.append(new INVOKESTATIC(getValueOfMethodIdx((BasicType) returnType, constPool)));
    }
  }
