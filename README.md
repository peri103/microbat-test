...
Please modify the DEPLOY_DIR by your $eclipse_root_folder\dropins\junit_lib\\. (**Note**: there is a "\\" at the end of your path.) After running the code, you will generate an instrumentator.jar under the DEPLOY_DIR folder.
