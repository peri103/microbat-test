...
public class JunitUtils {
  ...
  public static List<String> extractTestMethods(
      List<String> junitClassNames, URLClassLoader classLoader) throws ClassNotFoundException {
  ...
  private static void extractTestMethods(
      List<String> result, String className, URLClassLoader classLoader)
    ...
    for (Method method : methods) {
      ...
      result.add(ClassUtils.toClassMethodStr(className, method.getName()));
      // }
    }
  ...
  private static void findTestcasesInSuite(TestSuite suite, List<String> classMethods)
      throws ClassNotFoundException {
  ...
  public static List<Pair<String, String>> toPair(List<String> junitClassTestMethods) {
    List<Pair<String, String>> result =
        new ArrayList<Pair<String, String>>(junitClassTestMethods.size());
