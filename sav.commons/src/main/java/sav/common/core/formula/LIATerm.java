...
/**
 * The term in the linear integer arithmetic {@link LIAAtom} formula contains an integer coefficient
 * and a field variable which refers to a field defined in the target class or the classes of its
 * fields. We use ILATerm to distinguish it from the {@link DNFTerm} used in Disjunctive Normal
 * Form.
 *
 * @author Spencer Xiao
 */
