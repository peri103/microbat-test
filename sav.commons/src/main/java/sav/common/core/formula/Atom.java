...
/**
 * The abstract atomic expression used in this boolean library. The subclasses of this class can
 * represents different atomic expressions in its related theories(e.g., the Linear Integer
 * Arithmetic LIA for short) and must override the unimplemented abstract methods.
 *
 * @author Spencer Xiao
 */
