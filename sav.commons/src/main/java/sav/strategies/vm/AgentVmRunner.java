...
public class AgentVmRunner extends VMRunner {
  ...
  public AgentVmRunner(
      String agentJarPath, String agentOptionSeparator, String agentParamsSeparator) {
    this(agentJarPath);
  ...
  protected void buildVmOption(CollectionBuilder<String, ?> builder, VMConfiguration config) {
    ...
    if (agentParams != null) {
      sb.append("=").append(StringUtils.join(agentParams, getAgentParamsSeparator()));
    }
