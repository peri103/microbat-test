...
public class ClassLocation {
  ...
  public boolean equals(Object obj) {
    ...
    return classCanonicalName.equals(other.getClassCanonicalName()) && lineNo == other.getLineNo();
  }

  @Override
  public String toString() {
    return "ClassLocation [classCanonicalName=" + classCanonicalName + ", lineNo=" + lineNo + "]";
  }
