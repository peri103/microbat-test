...
public class PrimitiveValue extends ExecValue {
  ...
  public PrimitiveValue(
      String name, String strVal, String type, boolean isRoot, boolean isField, boolean isStatic) {
  ...
  public PrimitiveValue clone() {
    PrimitiveValue clonedValue =
        new PrimitiveValue(getVarName(), strVal, getPrimitiveType(), isRoot, isField, isStatic);
    return clonedValue;
  }
