...
public class BooleanValue extends PrimitiveValue {
  ...
  public BooleanValue(
      String name, boolean value, boolean isRoot, boolean isField, boolean isStatic) {
  ...
  public static BooleanValue of(
      String id, boolean value, boolean isRoot, boolean isField, boolean isStatic) {
  ...
  public PrimitiveValue clone() {
    BooleanValue clonedValue = new BooleanValue(getVarName(), value, isRoot, isField, isStatic);
    return clonedValue;
  }
