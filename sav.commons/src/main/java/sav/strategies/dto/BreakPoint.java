...
public class BreakPoint extends ClassLocation {
  ...
  public boolean equals(Object obj) {
    ...
    if (classCanonicalName == null) {
      if (other.classCanonicalName != null) return false;
    } else if (!classCanonicalName.equals(other.classCanonicalName)) return false;
  ...
  public static class Variable {
    ...
    @Override
    public String toString() {
      return "Variable [name=" + parentName + ", fullName=" + fullName + ", scope=" + scope + "]";
    }
