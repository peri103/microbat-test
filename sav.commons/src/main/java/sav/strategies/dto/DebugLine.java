...
public class DebugLine extends BreakPoint {
  ...
  public void put(BreakPoint orgBkp, int newLineNo) {
    // verify breakpoint
    Assert.assertTrue(
        orgBkp.classCanonicalName.equals(this.classCanonicalName),
        "inconsistent className.Expect ",
        this.classCanonicalName,
        "get",
        orgBkp.classCanonicalName);
    orgLines.add(orgBkp.lineNo);
  }
  ...
  public String toString() {
    return "DebugLine [orgLines=" + orgLines + ", vars=" + vars + ", id=" + getId() + "]";
  }
