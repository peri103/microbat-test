...
public interface IMutator {
  ...
  /**
   * Insert a new line of code right after a specific line of a class, the new statement must be
   * valid, and simple, and added just for debugging purpose. ex: for return statement like: return
   * foo; we need to generate something like this: Type temp = foo; return temp;
   */
