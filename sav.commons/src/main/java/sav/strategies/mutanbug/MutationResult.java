...
public class MutationResult {
  ...
  public void merge(MutationResult other) {
    if (!this.sourceFolder.equals(other.sourceFolder) || !this.className.equals(other.className)) {
      return;
    }
  ...
  public String toString() {
    return "MutationResult [className=" + className + ", mutatedFiles=" + mutatedFiles + "]";
  }
