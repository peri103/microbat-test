...
public class SimpleProgramTests {
  ...
  public void test17() {
    SimplePrograms simpleProgram = new SimplePrograms();
    boolean isFound =
        simpleProgram.searchInSortingMatrix1(new int[][] {{1, 3, 5}, {7, 9, 11}, {13, 15, 17}}, 11);
  ...
  public void test18() {
    SimplePrograms simpleProgram = new SimplePrograms();
    boolean isFound =
        simpleProgram.searchInSortingMatrix1(new int[][] {{1, 3, 5}, {7, 9, 11}, {13, 15, 17}}, 12);
  ...
  public void test21() {
    SimplePrograms simpleProgram = new SimplePrograms();
    boolean isFound =
        simpleProgram.searchInSortingMatrix1(new int[][] {{1, 3, 5}, {7, 9, 11}, {13, 15, 17}}, 1);
    assertEquals(true, isFound);
  }
  ...
  public void test22() {
    SimplePrograms simpleProgram = new SimplePrograms();
    boolean isFound =
        simpleProgram.searchInSortingMatrix1(new int[][] {{1, 3, 5}, {7, 9, 11}, {13, 15, 17}}, 17);
    assertEquals(true, isFound);
  }
