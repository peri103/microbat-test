...
public class BeliefPropagationClient extends Client {
  ...
  /**
   * Request the python server to run belief propagation algorithm to calculate the marginal
   * probability
   *
  ...
  public Map<String, Double> requestBP(final Collection<Constraint> constraints)
      throws IOException, InterruptedException {
  ...
  protected void sendGraphMsg(final Collection<Constraint> constraints)
      throws IOException, InterruptedException {
  ...
  protected void sendFactorMsg(final Collection<Constraint> constraints)
      throws IOException, InterruptedException {
    for (Constraint constraint : constraints) {
      this.notifyContinuoue();
