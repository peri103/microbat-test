...
//	 */
//	public VariableEncoder(Trace trace, List<TraceNode> executionList, List<VarValue> inputVars,
// List<VarValue> outputVars) {
...
////
////			// Since there are only one write variable, then the conclusion index should the one right
// after the read variable
////			Constraint constraint = new VariableConstraint(varsIncluded, readLen,
// PropagationProbability.HIGH);
////
////			// Set variables IDs
...
////			varsIncluded.set(0, totalLen);
////
////			Constraint constraint = new VariableConstraint(varsIncluded, predIdx,
// PropagationProbability.HIGH);
////			constraint.setVarsID(node);
////			constraints.add(constraint);
