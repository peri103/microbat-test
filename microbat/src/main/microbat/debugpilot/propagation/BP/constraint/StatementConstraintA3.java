...
/**
 * Statement constraint A3 If the control dominator is correct, when all the read variable is
 * correct, but the write variable is wrong, then the trace node is likely to be wrong
 *
 * <p>Condition: Node should have both read and written variables.
 *
 * @author David
 */
