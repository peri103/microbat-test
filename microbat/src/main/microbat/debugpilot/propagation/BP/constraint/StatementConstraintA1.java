 ...
 *
 * <p>If all the involved predicate, then the trace node will be correct.
 *
 * <p>Condition: The node should have both read and written variables.
 *
 * @author David
 */
