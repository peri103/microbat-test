...
public class MicrobatPreference extends PreferencePage implements IWorkbenchPreferencePage {
  ...
  public void init(IWorkbench workbench) {
    this.defaultTargetProject =
        Activator.getDefault().getPreferenceStore().getString(TARGET_PORJECT);
    ...
    this.defaultSupportConcurrentTrace =
        Activator.getDefault().getPreferenceStore().getString(SUPPORT_CONCURRENT_TRACE);
    this.defaultRecordSnapshot =
        Activator.getDefault().getPreferenceStore().getString(RECORD_SNAPSHORT);
    this.defaultRunWithDebugMode =
        Activator.getDefault().getPreferenceStore().getString(RUN_WITH_DEBUG_MODE);
    this.defaultAdvancedDetailInspector =
        Activator.getDefault().getPreferenceStore().getString(APPLY_ADVANCE_INSPECTOR);
    ...
    this.defaultJava7HomePath =
        Activator.getDefault().getPreferenceStore().getString(JAVA7HOME_PATH);
    this.defaultApplyRecodingOptimization =
        Activator.getDefault().getPreferenceStore().getString(RECORDING_OPTIMIZATION);
    this.defaultEnableMethodSplitting =
        Activator.getDefault().getPreferenceStore().getBoolean(REQUIRE_METHOD_SPLITTING);
    this.defaultRunWithDebugMode =
        Activator.getDefault().getPreferenceStore().getString(RUN_WITH_DEBUG_MODE);
    //		this.defaultProjectPath =
    // Activator.getDefault().getPreferenceStore().getString(PROJECT_PATH);
    //		this.defaultDropInFolder =
    // Activator.getDefault().getPreferenceStore().getString(DROP_IN_FOLDER_MICROBAT);
    //		this.defaultConfigPath =
    // Activator.getDefault().getPreferenceStore().getString(CONFIG_PATH_MICROBAT);
    //		this.defaultTestCaseID =
    // Activator.getDefault().getPreferenceStore().getString(TEST_CASE_ID_MICROBAT);
    //		this.defaultUseTestCaseID =
    // Activator.getDefault().getPreferenceStore().getString(USE_TEST_CASE_ID);
  ...
  private void createSettingGroup(Composite parent) {
    ...
    variableLayerText.setToolTipText(
        "how many layers of variable children does the debugger need to retrieve, -1 means"
            + " infinite.");
    ...
    recordingOptimizationButton.setText(
        "Apply trace recording optimization for interested library code");
    ...
    enableMethodSplittingButton =
        SWTFactory.createCheckbox(settingGroup, "Enable method splitting function", 2);
  ...
  public boolean performOk() {
    ...
    preferences.put(
        APPLY_ADVANCE_INSPECTOR, String.valueOf(this.advancedDetailInspectorButton.getSelection()));
    ...
    preferences.put(
        RECORDING_OPTIMIZATION, String.valueOf(this.recordingOptimizationButton.getSelection()));
    preferences.putBoolean(
        REQUIRE_METHOD_SPLITTING, this.enableMethodSplittingButton.getSelection());
    preferences.put(
        SUPPORT_CONCURRENT_TRACE, String.valueOf(this.supportConcurrentTraceButton.getSelection()));
    preferences.put(
        RUN_WITH_DEBUG_MODE, String.valueOf(this.runWithDebugModeButton.getSelection()));
    ...
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(TARGET_PORJECT, this.projectCombo.getText());
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(LANUCH_CLASS, this.lanuchClassText.getText());
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(TEST_METHOD, this.testMethodText.getText());
    //		Activator.getDefault().getPreferenceStore().putValue(CLASS_NAME,
    // this.classNameText.getText());
    //		Activator.getDefault().getPreferenceStore().putValue(LINE_NUMBER,
    // this.lineNumberText.getText());
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(RECORD_SNAPSHORT, String.valueOf(this.recordSnapshotButton.getSelection()));
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(
            APPLY_ADVANCE_INSPECTOR,
    ...
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(VARIABLE_LAYER, this.variableLayerText.getText());
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(RUN_TEST, String.valueOf(this.runTestButton.getSelection()));
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(JAVA7HOME_PATH, this.java7HomePathText.getText());
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(
            RECORDING_OPTIMIZATION,
            String.valueOf(this.recordingOptimizationButton.getSelection()));
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(
            REQUIRE_METHOD_SPLITTING,
            String.valueOf(this.enableMethodSplittingButton.getSelection()));
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(
            SUPPORT_CONCURRENT_TRACE,
            String.valueOf(this.supportConcurrentTraceButton.getSelection()));
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(RUN_WITH_DEBUG_MODE, String.valueOf(this.runWithDebugModeButton.getSelection()));
    //		Activator.getDefault().getPreferenceStore().putValue(DROP_IN_FOLDER_MICROBAT,
    // this.dropInFolderText.getText());
    //		Activator.getDefault().getPreferenceStore().putValue(CONFIG_PATH_MICROBAT,
    // this.configPathText.getText());
    //		Activator.getDefault().getPreferenceStore().putValue(PROJECT_PATH,
    // this.projectPathText.getText());
    //		Activator.getDefault().getPreferenceStore().putValue(TEST_CASE_ID_MICROBAT,
    // this.testCaseIDText.getText());
    //		Activator.getDefault().getPreferenceStore().putValue(USE_TEST_CASE_ID,
    // String.valueOf(this.useTestCaseIDButton.getSelection()));
