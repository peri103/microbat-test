...
public class ExecutionRangeTablePanel extends TableViewerEditablePanel<Entry> {
  ...
  class EntryInfoDialog extends TitleAreaDialog {
    ...
    /**
     * @param parentShell
     * @param enty In add op should be null
     * @param opType dialog.ADD or dialog.EDIT
     */
    ...
    private boolean saveInput() {
      ...
      if (className.equals("") || startLine.equals("") || endLine.equals("")) {
        MessageDialog.openError(
            shell, "Incomplete information", "Entry information must be complete!");
        return false;
      }
      try {
        ...
        if (startNo > endNo) {
          MessageDialog.openError(
              shell, "Wrong content", "The line number should be in ascending order!");
          return false;
        }
      } catch (Exception e) {
        MessageDialog.openError(
            super.getShell(), "Wrong content", "Make sure the line number is correct !");
        return false;
      }
