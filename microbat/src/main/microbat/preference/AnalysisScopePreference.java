  ...
  protected Control createContents(Composite parent) {
    Label hintLbl =
        SWTFactory.createWrapLabel(
            parent,
            "By default, only classes in source code are included, while all other classes in"
    ...
    includedTable =
        new AnalysisScopesTablePanel(content, "Add more packages/types to analyze:", false);
