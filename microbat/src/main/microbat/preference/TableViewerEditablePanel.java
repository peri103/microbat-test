...
public abstract class TableViewerEditablePanel<T> {
  ...
  protected TableViewer createTableViewer(Composite parent) {
    TableViewer tableViewer = new TableViewer(parent, SWT.BORDER | SWT.MULTI | SWT.FULL_SELECTION);
  ...
  private void registerListener() {
    ...
    editBtn.addSelectionListener(
        new SelectionAdapter() {
          ...
          public void widgetSelected(SelectionEvent e) {
            T firstElement =
                (T) ((StructuredSelection) tableViewer.getSelection()).getFirstElement();
    ...
    removeBtn.addSelectionListener(
        new SelectionAdapter() {
          @Override
          public void widgetSelected(SelectionEvent e) {
            List<T> elements = ((StructuredSelection) tableViewer.getSelection()).toList();
            onRemove(elements);
          }
        });
  }
  ...
  /**
   * @param kind TableViewerEditablePanel.ADD_BTN TableViewerEditablePanel.EDIT_BTN
  ...
  public Button getButton(int kind) {
    ...
    throw new IllegalArgumentException("Cannot find the button with kind = " + kind);
  }
