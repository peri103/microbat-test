...
public class TraceAgentRunner extends AgentVmRunner {
  ...
  public boolean run(Reader reader) throws SavException {
    ...
    try {
      ...
      addAgentParam(
          AgentParams.OPT_TRACE_RECORDER,
          reader.name()); // why is reader name used for recorder option?
  ...
  public void addAgentParams(String opt, Collection<?> values) {
    super.addAgentParam(
        opt, StringUtils.join(values, AgentConstants.AGENT_PARAMS_MULTI_VALUE_SEPARATOR));
  }

  public void addIncludesParam(List<String> includeLibs) {
    addFilterParam(
        includeLibs, AgentParams.OPT_INCLUDES_FILE, AgentParams.OPT_INCLUDES, "includes");
  }

  public void addExcludesParam(List<String> excludeLibs) {
    addFilterParam(
        excludeLibs, AgentParams.OPT_EXCLUDES_FILE, AgentParams.OPT_EXCLUDES, "excludes");
  }

  public void addFilterParam(
      List<String> filterLibs, String fileOpt, String opt, String filterType) {
