 ...
 * @author David
 */
public enum AttributeByteCodeType implements ByteCode_Type_Not_Used {
  ...
  public static boolean containOpCode(int opCode) {
    return Stream.of(AttributeByteCodeType.values())
        .map(element -> element.getOpCode())
        .anyMatch(element -> element == opCode);
  }
