...
public class DebugPilotPerspective implements IPerspectiveFactory {
  ...
  public void createInitialLayout(IPageLayout layout) {
    ...
    IFolderLayout topLeftFolder =
        layout.createFolder(
            DebugPilotPerspective.TOP_LEFT_LAYOUT_ID,
            IPageLayout.LEFT,
            0.25f,
    ...
    IFolderLayout bottomLeftFolder =
        layout.createFolder(
            DebugPilotPerspective.BOTTOM_LEFT_LAYOUT_ID,
            IPageLayout.BOTTOM,
            0.5f,
            DebugPilotPerspective.TOP_LEFT_LAYOUT_ID);
    ...
    IFolderLayout rightFolder =
        layout.createFolder(
            DebugPilotPerspective.RIGHT_LAYOUT_ID, IPageLayout.RIGHT, 0.6f, layout.getEditorArea());
    rightFolder.addView(DebugPilotFeedbackView.ID);

    IFolderLayout bottomFolder =
        layout.createFolder(
            DebugPilotPerspective.BOTTOM_LAYOUT_ID,
            IPageLayout.BOTTOM,
            0.5f,
            layout.getEditorArea());
