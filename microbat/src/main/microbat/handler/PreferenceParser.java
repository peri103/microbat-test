...
public class PreferenceParser {
  ...
  public static PropagatorType getPreferencePropagatorType() {
    final String propagatorTypeString =
        PreferenceParser.getPreferenceStringByKey(DebugPilotPreference.PROPAGATOR_TYPE_KEY);
    return propagatorTypeString == null
        ? PropagatorSettings.DEFAULT_PROPAGATOR_TYPE
        : PropagatorType.valueOf(propagatorTypeString);
  }

  //	public static boolean getPrferenceUseLocalServer() {
  //		final String string =
  // PreferenceParser.getPreferenceStringByKey(DebugPilotPreference.USE_LOCAL_SERVER_KEY);
  //		return string == null ? PropagatorSettings.DEFAULT_USE_LOCATL_SERVER :
  // Boolean.valueOf(string);
  //	}
  //
  //	public static String getPreferenceServerHost() {
  //		final String string =
  // PreferenceParser.getPreferenceStringByKey(DebugPilotPreference.SERVER_HOST_KEY);
  //		return string == null ? PropagatorSettings.DEFAULT_SERVER_HOST : string;
  //	}
  //
  //	public static int getPreferenceServerPort() {
  //		final String string =
  // PreferenceParser.getPreferenceStringByKey(DebugPilotPreference.SERVER_PORT_KEY);
  ...
  public static PathFinderType getPreferencePathFinderType() {
    final String string =
        PreferenceParser.getPreferenceStringByKey(DebugPilotPreference.PATHFINDER_TYPE_KEY);
    return string == null
        ? PathFinderSettings.DEFAULT_PATH_FINDER_TYPE
        : PathFinderType.valueOf(string);
  }

  public static RootCauseLocatorType getPreferenceRootCauseLocatorType() {
    final String string =
        PreferenceParser.getPreferenceStringByKey(DebugPilotPreference.ROOT_CAUSE_LOCATOR_TYPE_KEY);
    return string == null
        ? RootCauseLocatorSettings.DEFAULT_ROOT_CAUSE_LOCATOR_TYPE
        : RootCauseLocatorType.valueOf(string);
  }

  //	public static String getLogPath() {
  //		final String string =
  // PreferenceParser.getPreferenceStringByKey(DebugPilotPreference.LOG_PATH_KEY);
