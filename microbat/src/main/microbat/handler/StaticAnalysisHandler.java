    ...
    Job job =
        new Job("Preparing for Debugging ...") {
          ...
          protected IStatus run(IProgressMonitor monitor) {
            ...
            Map<String, List<Unit>> seeds =
                analyzer.analyzeSeeds(
                    TempVariableInfo.variableOption, TempVariableInfo.cu, TempVariableInfo.line);
                ...
                .syncExec(
                    new Runnable() {
                      ...
                      public void run() {
                        ...
                        //						Map<String, List<Unit>> newSeeds = removeExecutedSeeds(trace,
                        // seeds);
          ...
          private Map<String, List<Unit>> removeExecutedSeeds(
              Trace trace, Map<String, List<Unit>> seeds) {
