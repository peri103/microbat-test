          ...
          new Job("Preparing for Debugging ...") {
            ...
            protected IStatus run(IProgressMonitor monitor) {
              ...
              try {
                ...
                executingStatements =
                    collector.collectBreakPoints(appClassPath, Settings.isRunTest);
                ...
                if (collector.isMultiThread()) {
                  isMultiThread = true;
                  System.out.println(
                      "WARNING: It is multi-thread program, "
              ...
              if (stepNum != -1) {
                try {
                  ...
                  /**
                   * 2. find the variable scope for: 1) Identifying the same local variable in
                   * different trace nodes. 2) Generating variable ID for local variable.
                   */
