 ...
 *     <variableValues> <value id="1" isRoot="true" type="sample.Sample"> <variable id="951:3"
 *     name="s" type="LocalVar" varType="sample.Sample"> <lineNumber>21</lineNumber>
 *     <locationClass>sample.Sample</locationClass> </variable>
 *     <stringValue>[field=0,]</stringValue> <uniqueId>951</uniqueId> <childIds>2</childIds>
 *     </value> <value id="2" isRoot="false" type="int"> <variable id="951.field:3" name="field"
 *     type="FieldVar" varType="int"> <isStatic>false</isStatic> </variable>
 *     <stringValue>0</stringValue> </value> </variableValues>
 */
  ...
  private static class XmlBuilder {
    ...
    private String appendVarValue(VarValue varValue) {
      ...
      if (CollectionUtils.isNotEmpty(varValue.getChildren())) {
        ...
        addProperty(
            valueEle, VALUE_CHILDREN_PROP, StringUtils.join(childIds, VALUE_CHILDREN_SEPARATOR));
      }
      return valueId;
    }
