...
public class StartDebugHandler extends AbstractHandler {
  ...
  public Object execute(ExecutionEvent event) throws ExecutionException {
    ...
    if (Settings.isRunTest) {
      ...
      appClassPath.setTestCodePath(
          MicroBatUtil.getSourceFolder(Settings.launchClass, Settings.projectName));
    }
  ...
  protected void generateTrace(final AppJavaClassPath appClassPath) {
    try {
      ...
      Job job =
          new Job("Preparing for Debugging ...") {
  ...
  protected String generateTraceDir(AppJavaClassPath appPath) {
    ...
    if (appPath.getOptionalTestClass() != null) {
      ...
      traceFolder =
          FileUtils.getFilePath(
              MicroBatUtil.getTraceFolder(), Settings.projectName, appPath.getLaunchClass());
    }
  ...
  private String convertSignature(
      String classQulifiedName, int lineNumber, AppJavaClassPath appPath) {
