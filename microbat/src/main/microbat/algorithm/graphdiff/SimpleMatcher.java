...
public class SimpleMatcher implements Matcher {
  ...
  private GraphNode findTheBestMatch(
      GraphNode childBefore, List<? extends GraphNode> childrenAfter) {
    GraphNode node = null;
  ...
  @Override
  public List<MatchingGraphPair> matchList(
      List<? extends GraphNode> childrenBefore, List<? extends GraphNode> childrenAfter) {
