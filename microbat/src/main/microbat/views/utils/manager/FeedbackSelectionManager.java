...
public class FeedbackSelectionManager {
  ...
  public DPUserFeedback genDpUserFeedback(final TraceNode node) {
    ...
    YesNoButtonPair rootCauseSelection =
        this.feedbackYesNoButtonsMap.get(this.genRootCuaseFeedbackKey());
    if (rootCauseSelection.isYesButtonSelected()) {
      return new DPUserFeedback(DPUserFeedbackType.ROOT_CAUSE, node);
    }

    // This step is correct
    YesNoButtonPair correctSelection =
        this.feedbackYesNoButtonsMap.get(this.genCorrectFeedbackKey());
    ...
    YesNoButtonPair wrongPathSelection =
        this.feedbackYesNoButtonsMap.get(this.genWrongPathFeedbackKey());
  ...
  public boolean isValidSelection() {
    for (Map.Entry<UserFeedback, YesNoButtonPair> entry : this.feedbackYesNoButtonsMap.entrySet()) {
      ...
      if (feedback.getFeedbackType().equals(UserFeedback.ROOTCAUSE)
          && buttonPair.isYesButtonSelected()) {
        return true;
      }
  ...
  public void checkButtonBasedOnFeedback(final DPUserFeedback feedback) {
    switch (feedback.getType()) {
      case CORRECT:
         ...
         */
        for (Map.Entry<UserFeedback, YesNoButtonPair> entry :
            this.feedbackYesNoButtonsMap.entrySet()) {
  ...
  public void select(final UserFeedback userFeedback, final boolean isYesButton) {
    ...
    if (feedbackType.equals(UserFeedback.ROOTCAUSE)) {
      ...
      // If user select wrong path, no matter it is wrong or correct, that mean this step is not
      // root cause
      YesNoButtonPair pair = this.feedbackYesNoButtonsMap.get(userFeedback);
