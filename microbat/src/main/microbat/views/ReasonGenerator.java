...
public class ReasonGenerator {
  ...
  public final String WRONG_VARIABLE_VALUE =
      "This step is responsible for assigning wrong variable.";
  public final String INSPECT_DETAIL = "This step lets you check more details.";
  public final String BINARY_SEARCH =
      "Ok, it seems that I over-skipped some steps. Let's check one of them!";
  ...
  public String generateReason(StepRecommender recommender) {
    ...
    if (currentState == DebugState.SLICING) {
      ...
      if (!recommender.getLoopRange().getSkipPoints().isEmpty()) {
        buffer.append(
            "Note that I skip following steps because your feedback "
