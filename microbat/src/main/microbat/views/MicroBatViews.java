...
public class MicroBatViews {
      ...
      view =
          (DebugFeedbackView)
              PlatformUI.getWorkbench()
                  ...
                  .getActivePage()
                  .showView(MicroBatViews.DEBUG_FEEDBACK);
  ...
  public static DebugPilotFeedbackView getDebugPilotFeedbackView() {
    try {
      DebugPilotFeedbackView view =
          (DebugPilotFeedbackView)
              PlatformUI.getWorkbench()
                  .getActiveWorkbenchWindow()
                  .getActivePage()
                  .showView(DebugPilotFeedbackView.ID);
      return view;
    } catch (PartInitException e) {
      e.printStackTrace();
    }
        ...
        view =
            (ConcurrentTraceView)
                PlatformUI.getWorkbench()
                    .getActiveWorkbenchWindow()
                    .getActivePage()
                    .showView(MicroBatViews.CONCURRENT_TRACE);
      } else {
        view =
            (TraceView)
                PlatformUI.getWorkbench()
  ...
  //		try {
  //			view =
  // (ConcurrentTraceView)PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView(MicroBatViews.CONCURRENT_TRACE);
  //		} catch (PartInitException e) {
  //			e.printStackTrace();
  //		}
  //
