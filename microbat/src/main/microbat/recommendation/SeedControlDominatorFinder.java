...
public class SeedControlDominatorFinder {
  public List<BreakPoint> findSeedControlDominators(
      List<BreakPoint> collectedBreakPoints, Map<MethodNode, List<InstructionHandle>> allSeeds) {
  ...
  private boolean isControlDominateSeed(
      MethodNode node, CFG cfg, List<InstructionHandle> seedInstructions, BreakPoint point) {
