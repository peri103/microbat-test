...
public class ContextManager {
  ...
  /**
   * Add a -classpath argument to the arguments passed to the exec'ed VM with the contents of
   * CLASSPATH environment variable, if -classpath was not already specified.
   *
   * @param javaArgs the arguments to the VM being exec'd that potentially has a user specified
   *     -classpath argument.
