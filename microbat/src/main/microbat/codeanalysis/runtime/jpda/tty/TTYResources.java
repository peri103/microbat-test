    ...
    Object[][] temp =
        new Object[][] {
          ...
          {"All threads suspended.", "All threads suspended."},
          {
            ...
            "Argument {0} is not defined for connector: {1}"
          },
          ...
          {"Breakpoints set:", "Breakpoints set:"},
          {
            ...
            "Breakpoints can be located only in classes.  {0} is an interface or array."
          },
          ...
          {"Cannot assign to a method invocation", "Cannot assign to a method invocation"},
          {
            ...
            "Cannot specify command line with connector: {0}"
          },
          {
            "Cannot specify target vm arguments with connector:",
            "Cannot specify target VM arguments with connector: {0}"
          },
          {
          ...
          {"colon space", ": "},
          {
            ...
            "Command ''{0}'' is not supported on the target VM"
          },
          {
            "Command is not supported on a read-only VM connection",
            "Command ''{0}'' is not supported on a read-only VM connection"
          },
          {
            "Command not valid until the VM is started with the run command",
            "Command ''{0}'' is not valid until the VM is started with the ''run'' command"
          },
          ...
          {"Current method is native", "Current method is native"},
          {
            ...
            "Current thread {0} died. Execution continuing..."
          },
          ...
          {"is not a valid id or class name", "\"{0}\" is not a valid id or class name."},
          {
            ...
            "\"{0}\" is not a valid line number or method name for class \"{1}\""
          },
          ...
          {"killing thread:", "killing thread: {0}"},
          {
            ...
            "Source line numbers not available for this location."
          },
          ...
          {"Listening at address:", "Listening at address: {0}"},
          {
            ...
            "Local variable information not available.  Compile with -g to generate variable"
                + " information"
          },
          ...
          {
            "minus version",
            "This is {0} version {1,number,integer}.{2,number,integer} (Java SE version {3})"
          },
          ...
          {"No frames on the current call stack", "No frames on the current call stack"},
          {
            ...
            "No linenumber information for {0}.  Try compiling with debugging on."
          },
          ...
          {"Parse exception:", "Parse Exception: {0}"},
          {
            ...
            "Usage: {0} <class>:<line_number> or\n"
                + "       {1} <class>.<method_name>[(argument_type,...)]"
          },
          {"Removed:", "Removed: {0}"},
          {
            "Requested stack frame is no longer active:",
            "Requested stack frame is no longer active: {0,number,integer}"
          },
          {
          ...
          {"Thread description name sleepingStatus", "  {0} {1} sleeping"},
          {
            ...
            "  {0} {1} waiting in a monitor (at breakpoint)"
          },
          ...
          {"watch modification of", "watch modification of {0}.{1}"},
          {
            "zz help text",
            "** command list **\n"
                + "connectors                -- list available connectors and transports in this"
                + " VM\n"
                + "\n"
