...
class BreakpointSpec extends EventRequestSpec {
  ...
  BreakpointSpec(ReferenceTypeSpec refSpec, String methodId, List<String> methodArgs)
  ...
  String errorMessageFor(Exception e) {
    if (e instanceof AmbiguousMethodException) {
      ...
      return (MessageOutput.format(
          "No method in", new Object[] {methodName(), refSpec.toString()}));
      ...
      return (MessageOutput.format(
          "No code at line", new Object[] {new Long(lineNumber()), refSpec.toString()}));
    } else if (e instanceof InvalidTypeException) {
      return (MessageOutput.format(
          "Breakpoints can be located only in classes.", refSpec.toString()));
    } else {
  ...
  private Location location(ReferenceType refType)
      throws AmbiguousMethodException,
          AbsentInformationException,
          NoSuchMethodException,
          LineNotFoundException {
