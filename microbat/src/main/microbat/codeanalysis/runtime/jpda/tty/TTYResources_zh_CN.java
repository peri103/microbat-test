  ...
  public Object[][] getContents() {
    Object[][] temp =
        new Object[][] {
          ...
          {
            "Can only trace",
            "\u53EA\u80FD\u8DDF\u8E2A 'methods', 'method exit' \u6216 'method exits'"
          },
          {
          ...
          {
            "minus version",
            "\u8FD9\u662F{0}\u7248\u672C {1,number,integer}.{2,number,integer} (Java SE"
                + " \u7248\u672C {3})"
          },
          ...
          },
          {
            ...
            "\u7528\u6CD5: catch [uncaught|caught|all] <class id>|<class pattern>"
          },
          {
            "Usage: ignore exception",
            "\u7528\u6CD5: ignore [uncaught|caught|all] <class id>|<class pattern>"
          },
          ...
          {"watch modification of", "\u76D1\u89C6{0}.{1}\u7684\u4FEE\u6539"},
          {
            ...
            "** \u547D\u4EE4\u5217\u8868 **\n"
                ...
                + "suspend [thread id(s)]    -- \u6302\u8D77\u7EBF\u7A0B (\u9ED8\u8BA4\u503C:"
                + " all)\n"
                + "resume [thread id(s)]     -- \u6062\u590D\u7EBF\u7A0B (\u9ED8\u8BA4\u503C:"
                + " all)\n"
                + "where [<thread id> | all] -- \u8F6C\u50A8\u7EBF\u7A0B\u7684\u5806\u6808\n"
                + "wherei [<thread id> | all]-- \u8F6C\u50A8\u7EBF\u7A0B\u7684\u5806\u6808,"
                + " \u4EE5\u53CA pc \u4FE1\u606F\n"
                + "up [n frames]             -- \u4E0A\u79FB\u7EBF\u7A0B\u7684\u5806\u6808\n"
          ...
          },
          {
            ...
            "\u7528\u6CD5: {0} <options> <class> <arguments>\n\n"
                ...
                + "                      \u7ACB\u5373\u542F\u52A8 VM \u800C\u4E0D\u662F\u7B49\u5F85"
                + " ''run'' \u547D\u4EE4\n"
                + "    -listconnectors   \u5217\u51FA\u6B64 VM"
                + " \u4E2D\u7684\u53EF\u7528\u8FDE\u63A5\u5668\n"
                + "    -connect <connector-name>:<name1>=<value1>,...\n"
                + "                     "
                + " \u4F7F\u7528\u6240\u5217\u53C2\u6570\u503C\u901A\u8FC7\u6307\u5B9A\u7684\u8FDE\u63A5\u5668\u8FDE\u63A5\u5230\u76EE\u6807"
                + " VM\n"
                + "    -dbgtrace [flags] \u8F93\u51FA\u4FE1\u606F\u4F9B\u8C03\u8BD5{0}\n"
                + "    -tclient          \u5728 HotSpot(TM)"
                + " \u5BA2\u6237\u673A\u7F16\u8BD1\u5668\u4E2D\u8FD0\u884C\u5E94\u7528\u7A0B\u5E8F\n"
                + "    -tserver          \u5728 HotSpot(TM)"
                + " \u670D\u52A1\u5668\u7F16\u8BD1\u5668\u4E2D\u8FD0\u884C\u5E94\u7528\u7A0B\u5E8F\n\n"
                + "\u8F6C\u53D1\u5230\u88AB\u8C03\u8BD5\u8FDB\u7A0B\u7684\u9009\u9879:\n"
