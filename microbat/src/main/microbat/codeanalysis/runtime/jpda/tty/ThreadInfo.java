...
class ThreadInfo {
  ...
  private static List<ThreadInfo> threads =
      Collections.synchronizedList(new ArrayList<ThreadInfo>());
   ...
   *
   * @return the number of the current stackframe. Frame zero is the closest to the current program
   *     counter
   */
  ...
  /**
   * Change the current stackframe to be one or more frames higher (as in, away from the current
   * program counter).
   *
