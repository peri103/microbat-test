...
public class MethodBreakpointSpec extends BreakpointSpec {
  ...
  private Location location(ClassType clazz)
  ...
  /**
   * Remove unneeded spaces and expand class names to fully qualified names, if necessary and
   * possible.
   */
