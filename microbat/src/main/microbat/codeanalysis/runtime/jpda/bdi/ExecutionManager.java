...
public class ExecutionManager {
  ...
  /**
   * Return a list of ReferenceType objects for all currently loaded classes and interfaces. Array
   ...
   * class name is specified, else return null if there is none.
   *
   * <p>In general, we must return a list of types, because multiple class loaders could have loaded
   * a class with the same fully-qualified name.
   */
  ...
  public void run(boolean suspended, String vmArgs, String className, String args)
    ...
    startSession(
        new ChildSession(this, vmArgs, cmdLine, appInput, appOutput, appError, diagnostics));
  }
  ...
  private Session internalAttach(
      AttachingConnector connector, Map<String, Connector.Argument> arguments) {
    try {
  ...
  private Session internalListen(
      ListeningConnector connector, Map<String, Connector.Argument> arguments) {
    try {
  ...
  public void stepIntoLine(ThreadReference thread)
      throws NoSessionException, AbsentInformationException {
  ...
  private HashMap<ThreadReference, ThreadInfo> threadInfoMap =
      new HashMap<ThreadReference, ThreadInfo>();
  ...
  private InputListener appInput =
      new InputListener() {
        @Override
  ...
  private OutputListener appOutput =
      new OutputListener() {
        @Override
  ...
  private OutputListener appError =
      new OutputListener() {
        @Override
        public void putString(String string) {
          ArrayList<OutputListener> l = new ArrayList<OutputListener>(appEchoListeners);
  ...
  public BreakpointSpec createMethodBreakpoint(
  ...
  public ExceptionSpec createExceptionIntercept(
