...
public class ExecutionStatementCollector extends Executor {
  ...
  public List<BreakPoint> collectBreakPoints(
      AppJavaClassPath appClassPath, boolean isTestcaseEvaluation) {
    long t1 = System.currentTimeMillis();
    List<String> excludes =
        MicroBatUtil.extractExcludeFiles("", appClassPath.getExternalLibPaths());
          ...
          for (Event event : eventSet) {
            ...
            if (event instanceof VMStartEvent) {
              ...
              try {
                ...
                System.err.println(
                    "Source name is unknown: " + location.declaringType().toString());
                continue;
              }
              ...
              BreakPoint breakPoint =
                  new BreakPoint(
                      location.declaringType().name(), declaringCompilationUnit, lineNumber);
