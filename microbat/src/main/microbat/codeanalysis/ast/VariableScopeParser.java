...
public class VariableScopeParser {
  ...
  // JavaUtil.findCompilationUnitInProject(breakPoint.getClassCanonicalName());
  ...
  //
  //		/**
  //		 * Analyzing the byte code could let us know that a "this" local variable is implicitly read
  // or written, however,
  ...
  public LocalVariableScope parseMethodScope(
      String typeName, final int lineNumber, final String variableName, AppJavaClassPath appPath) {
