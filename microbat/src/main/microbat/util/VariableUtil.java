...
public class VariableUtil {
  ...
  /**
   * For now, the virtual variable is never considered as equivalent (or, compatible). It means that
   * the path between method invocation is not jumped, which facilitates the abstraction intention.
   * That is, the jump occurs only in the same abstraction level.
   *
   * @param var1
   * @param var2
   * @return
