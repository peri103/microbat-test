...
public class TestCaseRunner extends ExecutionStatementCollector {
  ...
  /**
   * check whether it is a passing test case and having compilation error, however, it cannot check
   * whether it is over long.
   *
   * @param appClassPath
   */
  ...
  protected void addBreakPointWatch(
      EventRequestManager erm, ThreadReference threadReference, Location loc) {
