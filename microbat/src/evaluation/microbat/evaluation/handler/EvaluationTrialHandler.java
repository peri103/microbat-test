...
public class EvaluationTrialHandler extends AbstractHandler {
  ...
  private void runSingeTrial() {
    ...
    // "org.apache.commons.math.analysis.interpolation.LinearInterpolatorTest";
    ...
    String mutationFile =
        "C:\\microbat_evaluation\\apache-common-math-2.2\\"
    ...
    //		String mutationFile =
    // "C:\\microbat_evaluation\\apache-common-math-2.2\\org.apache.commons.math.util.FastMath_1267_19_1\\FastMath.java";
    ...
    try {
      ...
      analyzer.runEvaluationForSingleTrial(
          testClassName,
          testMethodName,
          mutationFile,
          unclearRate,
