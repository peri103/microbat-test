...
public class TraceModelConstructor {
  ...
  public Trace constructTraceModel(
    ...
    /**
     * 3. find the variable scope for: 1) Identifying the same local variable in different trace
     * nodes. 2) Generating variable ID for local variable.
     */
    ...
    try {
      tcExecutor.run(
          runningStatements,
          executionOrderList,
          new SubProgressMonitor(new NullProgressMonitor(), 0),
          stepNum,
          true);
