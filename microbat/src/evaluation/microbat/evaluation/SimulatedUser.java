...
public class SimulatedUser {
  ...
  private List<ChosenVariableOption> checkWrongVariableOptions(
      TraceNodePair pair, Trace mutatedTrace) {
  ...
  public UserFeedback feedback(
    ...
    boolean isClear =
        isClear(suspiciousNode, labeledUnclearNodeVisitedTimes, isFirstTime, maxUnclearFeedbackNum);
    //		isClear = true;
  ...
  private boolean isClear(
      TraceNode suspiciousNode,
      HashMap<TraceNode, Integer> labeledUnclearNodeVisitedTimes,
      boolean isFirstTime,
      int maxUnclearFeedbackNum) {
