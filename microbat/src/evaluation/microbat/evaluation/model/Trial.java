...
public class Trial {
  ...
  public boolean equals(Object obj) {
    ...
    if (mutatedLineNumber != other.mutatedLineNumber) return false;
    if (testCaseName == null) {
      if (other.testCaseName != null) return false;
    } else if (!testCaseName.equals(other.testCaseName)) return false;
    return true;
  }
