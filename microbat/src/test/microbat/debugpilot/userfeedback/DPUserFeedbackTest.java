...
public class DPUserFeedbackTest {
  ...
  public void testConstructor2() {
    ...
    DPUserFeedback feedback1 =
        new DPUserFeedback(DPUserFeedbackType.WRONG_VARIABLE, this.node1, wrongVars, correctVars);
    ...
    assertThrows(
        ...
        () -> {
          @SuppressWarnings("unused")
          DPUserFeedback feedback2 =
              new DPUserFeedback(DPUserFeedbackType.ROOT_CAUSE, null, wrongVars, null);
        });
