...
public class MessageProcessorTest {
  ...
  public void testGraphMessage() {
    ...
    Constraint constraint1 =
        new VariableConstraintA1(this.node, this.writeVar1, this.propagationProbability);
    ...
    final String expected =
        "VC1_0("
            + this.readVar1.getVarID()
            + ","
            + this.writeVar1.getVarID()
            + ")VC2_0("
            + this.readVar1.getVarID()
            + ","
            + this.writeVar1.getVarID()
  ...
  public void testFactorMessage() {
    ...
    final String expected =
        "2&VC1_0&"
            ...
            + ","
            + this.writeVar1.getVarID()
            + "&0.95*2,0.05*1,0.95*1&"
            + "2&VC2_0&"
            + this.readVar1.getVarID()
            + ","
            + this.writeVar1.getVarID()
            + "&0.95*1,0.05*1,0.95*2";
