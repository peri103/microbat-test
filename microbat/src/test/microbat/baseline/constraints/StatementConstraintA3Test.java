...
public class StatementConstraintA3Test extends ConstraintTest {
  ...
  public void test2R1W0P() {
    ...
    double[] expected =
        new double[] {
          0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.05, 0.95,
          0.95
        };
  ...
  public void test2R2W0P() {
    ...
    double[] expected =
        new double[] {
          ...
          0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.05, 0.95, 0.05, 0.95, 0.05,
          0.95, 0.95
        };
  ...
  public void test1R1W1P() {
    ...
    double[] expected =
        new double[] {
          0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.05, 0.95, 0.95, 0.95,
          0.95
        };
  ...
  public void test2R1W1P() {
    ...
    double[] expected =
        new double[] {
          0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95,
          0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.05, 0.95, 0.95,
          0.95, 0.95
        };
  ...
  public void test2R2W1P() {
    ...
    double[] expected =
        new double[] {
          ...
          0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95,
          0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95,
          0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.05, 0.95, 0.95, 0.95, 0.05, 0.95, 0.95, 0.95, 0.05,
          0.95, 0.95, 0.95, 0.95
        };
