...
public class ExperimentVerifierTest {
  ...
  public void compareMath() throws IOException {
    String resultFile =
        "E:/Shared_folder/learntest/evosuite-math/evosuite_graphCoverage_result.xlsx";
    ...
    ExperimentReportComparisonReporter.reportChange(
        resultFile, oldReport, newReport, Arrays.asList(new TextComparisonRule(null)), keys);
  }
  ...
  public void test() throws IOException {
    ...
    ExperimentReportComparisonReporter.reportChange(
        ...
        oldReport,
        newReport,
        Arrays.asList(new TextComparisonRule(null), new SimulatorComparisonRule()),
        keys);
  }
  ...
  public void generateReportAlignment() throws IOException {
    ...
    ComparedReportGenerator.generateReport(
        resultFile, Arrays.asList(report0, report1, report2, report3), keys);
  }
}
