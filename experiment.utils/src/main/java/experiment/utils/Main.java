...
public class Main {
  ...
  public void test() throws ParseException, IOException {
    main(
        new String[] {
          "-keys",
          "data#ProjectId#Class#Method",
          "-c",
          "-input_excels",
          "/Users/lylytran/Projects/Evosuite/experiments/test-reports/evoTest-reports/allMethods-flag-filtered-default.xlsx",
          "/Users/lylytran/Projects/Evosuite/experiments/test-reports/evoTest-reports/allMethods.xlsx",
          "-workingFolder",
          "/Users/lylytran/Projects/Evosuite/experiments/test-reports/evoTest-reports",
          //				"-combCmpRules", ComparisonRuleEnum.numIncr + "#Coverage",
          // ComparisonRuleEnum.numDecr + "#Age",
          "-cmpRules",
          ComparisonRuleEnum.numIncr + "#Coverage",
          ComparisonRuleEnum.numDecr + "#Age",
          "-cmpStats"
        });
  }
      ...
      case COMPARISON:
        ...
        String reportFile =
            FileUtils.getFilePath(
                params.getWorkingFolder(),
                newExcelName.substring(0, newExcelName.indexOf(".xlsx")) + "_compare.xlsx");
        ...
        main.compareExcels(
            params.getInputExcels().get(0),
            params.getInputExcels().get(1),
            reportFile,
            params.getComparisonKeys(),
            params.getComparisonRules());
        break;
    }
  }
