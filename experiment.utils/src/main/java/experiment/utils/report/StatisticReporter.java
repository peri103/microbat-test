...
public class StatisticReporter implements IReporter {
  ...
  public void writeChanges(ReportChanges reportChanges, String sheetName, String[] mergedHeaders)
    ...
    sb.append("---------------------------------------------------------------------\n")
        .append("Missing Rows: ")
        .append(CollectionUtils.getSize(reportChanges.getMissingRecords()))
        .append("\n")
        .append("---------------------------------------------------------------------\n");
    ...
    sb.append("---------------------------------------------------------------------\n")
        .append("Added Rows: ")
        .append(CollectionUtils.getSize(reportChanges.getAddedRecords()))
        .append("\n")
        .append("---------------------------------------------------------------------\n");
    ...
    for (IComparisonRule rule : reportChanges.getAllRules()) {
      sb.append("---------------------------------------------------------------------\n")
          .append("ComparisonRule: ")
          .append(rule.getName())
          .append(" [")
          .append(StringUtils.join(rule.getComparisonColumns(), ","))
          .append("]")
          .append("\n")
          .append("Improved: ")
          .append(CollectionUtils.getSize(reportChanges.getImproves().get(rule)))
          .append("\n")
          .append("Declined: ")
          .append(CollectionUtils.getSize(reportChanges.getDeclines().get(rule)))
          .append("\n")
          .append("Changed: ")
          .append(CollectionUtils.getSize(reportChanges.getChanges().get(rule)))
          .append("\n")
          .append("---------------------------------------------------------------------\n");
      sb.append("IMPROVED: \n");
