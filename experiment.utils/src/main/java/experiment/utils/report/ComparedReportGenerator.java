...
public class ComparedReportGenerator {
  ...
  public static void generateReport(
      String resultFile, List<String> reportsFiles, Map<String, List<String>> keyCols) {
    try {
  ...
  private static List<String> mergeHeaders(
      ExcelReader oldExcelReader, List<ExcelReader> newExcelReaders, String sheetName) {
  ...
  private static void writeComparation(
      List<Records> allRecordsList,
