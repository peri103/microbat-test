...
public class ExcelUtils {
  ...
  public static void createSheet(
      ExcelWriter excelWriter, String sheetName, ExcelReader excelReader, int headerRowNum) {
  ...
  public static List<String> collectKeys(
      String excelFile, String sheetName, List<String> keyCols, String separator) {
