...
public class SingleMutation {
  ...
  public static List<SingleMutation> from(
      Map<String, MutationResult> mutations, String junitTestClass, String testMethod) {
    List<SingleMutation> singleMus = new ArrayList<>();
    String bugIdPrefix =
        StringUtils.join("#", ClassUtils.getSimpleName(junitTestClass), testMethod);
