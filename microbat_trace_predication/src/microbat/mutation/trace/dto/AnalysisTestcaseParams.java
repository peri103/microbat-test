...
public class AnalysisTestcaseParams {
  ...
  public AnalysisTestcaseParams(
    ...
    analysisOutputFolder =
        MuRegressionUtils.getAnalysisOutputFolder(
            analysisParams.getMutationOutputSpace(), projectName, junitClassName, testMethod);
    projectOutputFolder =
        FileUtils.getFilePath(analysisParams.getMutationOutputSpace(), "mutation", projectName)
            + File.separator;
