...
public class MuRegressionUtils {
  ...
  public static void fillMuBkpJavaFilePath(
      Trace buggyTrace, String muJFilePath, String muClassName) {
  ...
  public static String getValidMutationCaseFilePath(
      String projectName, String mutationOutputSpace) {
    return FileUtils.getFilePath(
        mutationOutputSpace, "mutation", projectName, "validMutationCases.csv");
  }

  public static String getAnalysisOutputFolder(
      String mutationOutputSpace, String projectName, String junitClassName, String testMethod) {
    return FileUtils.getFilePath(
        mutationOutputSpace,
        "mutation",
        projectName,
        ClassUtils.getSimpleName(junitClassName),
        testMethod);
  }
}
