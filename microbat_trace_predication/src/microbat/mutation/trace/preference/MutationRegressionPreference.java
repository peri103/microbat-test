...
public class MutationRegressionPreference extends PreferencePage
  ...
  protected Control createContents(Composite parent) {
    ...
    runAllProjectsInWorkspaceCb =
        SWTFactory.createCheckbox(compo, "Run all projects in workspace", 2);
  ...
  protected void updateBugIdList() {
    ...
    List<String> bugIds =
        MutationCase.loadAllMutationBugIds(targetProject, mutationOutputSpaceTb.getText());
  ...
  public boolean performOk() {
    IEclipsePreferences preferences =
        ConfigurationScope.INSTANCE.getNode("muregression.preference");
    ...
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(RUN_ALL_PROJECTS_IN_WORKSPACE_KEY, runAllProjecsInWorkspace);
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(MUTATION_OUTPUT_SPACE, this.mutationOutputSpaceTb.getText());
    Activator.getDefault()
        .getPreferenceStore()
        .putValue(TARGET_PROJECT_KEY, this.projectCombo.getText());
