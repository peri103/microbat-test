...
public class MutationGenerationHandler extends AbstractHandler {
  ...
  private void generateMutations(
    ...
    MutationExperimentMonitor experimentMonitor =
    ...
    for (IJavaElement element : testRoot.getChildren()) {
      if (element instanceof IPackageFragment) {
        mutationGenerator.generateMutations(
            (IPackageFragment) element, analysisParams, experimentMonitor);
      }
    }
  }
}
