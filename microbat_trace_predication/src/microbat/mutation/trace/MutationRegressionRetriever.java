...
public class MutationRegressionRetriever {
  ...
  public MuRegression retrieveRegression(
      String targetProject,
      String mutationBugId,
      IProgressMonitor monitor,
      boolean useSliceBreaker,
      int breakerLimit)
  ...
  private MuRegression buildRegression(
      MutationCase mutationCase, MutationExecutionResult executionResult) {
