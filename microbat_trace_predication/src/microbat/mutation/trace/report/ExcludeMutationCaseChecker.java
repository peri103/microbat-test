...
public class ExcludeMutationCaseChecker implements IMutationCaseChecker {
  ...
  private void readFromMutationCaseCsv(String targetProject, AnalysisParams analysisParams)
      throws IOException {
    String csvFilePath = null;
    if (targetProject.contains("JFreeChart")) {
      csvFilePath =
          "/Users/lylytran/Projects/RemoteShare/microbat-experiment/jfreechart-mutationCases.csv";
    } else if (targetProject.contains("lang")) {
      csvFilePath =
          "/Users/lylytran/Projects/RemoteShare/microbat-experiment/common-lang-mutationCases.csv";
    }
