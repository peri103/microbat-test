...
public class MutationExperimentMonitor extends BasicMutationExperimentMonitor
    implements IMutationExperimentMonitor {
  private IMutationCaseChecker mutationCaseFilter;
  private ExcelReporter reporter;

  public MutationExperimentMonitor(
      IProgressMonitor progressMonitor, String targetProject, AnalysisParams analysisParams)
      throws IOException {
  ...
  public void reportTrial(
      ...
      TraceExecutionInfo killingMutatantTrace,
  ...
  @Override
  public void reportMutationCase(
      AnalysisTestcaseParams params,
      TraceExecutionInfo correctTrace,
  ...
  @Override
  public void reportEmpiralTrial(
      String fileName,
    ...
    recorder.export(
        trials, params.getProjectName(), mutation.getMutationBugId(), mutation.getMutationType());
  }
