...
public class VariableSubstitutionTest {
  ...
  public void whenLocalVariableInSameScopeMatch() {
    List<VariableDescriptor> candidates =
        variableSubstitution.findSubstitutions(
            new PrimitiveType(Primitive.Int), 15, Integer.MAX_VALUE);
  ...
  public void whenlocalVariableInSameScopeNotVisible() {
    List<VariableDescriptor> candidates =
        variableSubstitution.findSubstitutions(
            new PrimitiveType(Primitive.Int), 13, Integer.MAX_VALUE);
  ...
  public void whenLocalVariableInParentScopeMatch() {
    List<VariableDescriptor> candidates =
        variableSubstitution.findSubstitutions(
            new PrimitiveType(Primitive.Double), 25, Integer.MAX_VALUE);
  ...
  public void whenLocalVariableInChildScopeMatch() {
    List<VariableDescriptor> candidates =
        variableSubstitution.findSubstitutions(
            new PrimitiveType(Primitive.Double), 22, Integer.MAX_VALUE);
  ...
  public void whenLocalVariableInChildScopeButSameLineMatch() {
    List<VariableDescriptor> candidates =
        variableSubstitution.findSubstitutions(new PrimitiveType(Primitive.Int), 38, 21);
  ...
  public void whenOuterClassFieldMatch() {
    List<VariableDescriptor> candidates =
        variableSubstitution.findSubstitutions(
            new PrimitiveType(Primitive.Double), 33, Integer.MAX_VALUE);
