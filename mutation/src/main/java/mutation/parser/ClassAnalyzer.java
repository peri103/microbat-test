...
public class ClassAnalyzer {
  ...
  public ClassDescriptor parseClassOrInterface(
      CompilationUnit cu, ClassOrInterfaceDeclaration clDecl) {
  ...
  public MethodDescriptor parseMethod(MethodDeclaration medDecl) {
    MethodDescriptor med = new MethodDescriptor(medDecl.getBeginLine(), medDecl.getEndLine());
  ...
  public VariableDescriptor parseFieldDeclId(FieldDeclaration fieldDecl, VariableDeclaratorId vId) {
    VariableDescriptor vd = new VariableDescriptor();
    vd.setName(vId.getName());
