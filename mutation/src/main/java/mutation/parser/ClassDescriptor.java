...
public class ClassDescriptor {
  ...
  public String getQuantifiedName() {
    if (outterClass == null) return (packageName == null ? "" : packageName + ".") + name;
    else return outterClass.getQuantifiedName() + "$" + name;
  }
  ...
  public VariableDescriptor getVarFromName(String quantifiedName, int beginLine, int endLine) {
    // TODO LLT;
    return null;
  }
